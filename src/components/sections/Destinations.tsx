        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {[
              ...
              { name: 'זנזיבר', desc: 'איים אפריקאים עם מים טורקיז ותרבות עשירה', img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&q=80' },
              { name: 'פיליפינים', desc: 'אלפי איים, צלילה מדהימה וחופים בתולים', img: 'https://images.unsplash.com/photo-1516690561799-46d8f74f9abf?w=800&q=80' },
              ...
              { name: 'בולגריה', desc: 'חופי הים השחור, הרים ומחירים נוחים', img: 'https://images.unsplash.com/photo-1473116763249-2faaef81ccda?w=800&q=80' },
